						...
						ADD FOOD
                                ...
                                <form class="login100-form validate-form" action="<?php $PHP_SELF?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="wrap-input100 validate-input m-b-26" >
                                        ...
                                        <input class="input100" type="file" name="pic" placeholder="Picture">
...
//              $target_dir="uploads/";
//              $target_file=$target_dir.basename($_FILES["pic"]["tmp_name"]);
//              $imageFileType =strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
                ...
                if($name!=="" && $des!==""&& $price!=="")
                {
                    ...
                    $sql = "INSERT INTO food (f_name,f_des,f_price,f_pic) VALUES('$name','$des','$price','$file_name')";
