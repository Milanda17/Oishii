                ...
                <div class="grid">
                    ...
                    <div class="row">
                        <table class="table table-hover">
                            ...
                            $sql = "SELECT f_name,o_price,size,o_id,date FROM orders INNER JOIN food ON orders.f_id=food.f_id WHERE c_name='$c_name' AND o_make='1'";
                            $sql2="SELECT SUM(o_price)AS t_price,c_name FROM orders WHERE c_name='$c_name' AND o_make='1' GROUP By c_name";
                    ...
                    <div class="row">
                        <form action="admin_order.php" method="post">
                            ...
                            <button type="submit" class="btn btn-success btn-lg" name="all_done">All Done</button>
                        </form>
